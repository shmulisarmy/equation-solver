      ...
      >
        {levelInfo.map((level: Level) => {
          ...
          >
            ...
            <LevelAttributeAndTags isHovered={isHovered}
              level={level}
              lockedLevelOpacity={lockedLevelOpacity}
            />
...
function SubExpressionsSvg({
  level,
  lockedLevelOpacity,
}: {
  level: Level;
  lockedLevelOpacity: number;
}) {
  return (
    <span
      style={{
...
function LevelAttributeAndTags({
  level,
  lockedLevelOpacity,
  isHovered,
}: {
