...
export const levelInfo = createMutable<{locked: boolean, number: number, difficulty: string, completed_in: number, "contains square root"?: boolean, stars?: number}[]>([
    ...
    {locked: false, number: 2, difficulty: "Easy", completed_in: 3},
    {locked: false, number: 3, difficulty: "Easy", completed_in: 3},
    {locked: false, number: 4, difficulty: "Easy", completed_in: 3},
    {locked: false, number: 5, difficulty: "Super Easy", completed_in: 0},
